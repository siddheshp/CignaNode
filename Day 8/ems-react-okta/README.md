...
- ✅ View all employees in a table (No authentication required)
- ✅ Add new employees (Requires Admin role)
- ✅ Edit existing employee details (Requires Admin role)
- ✅ Delete employees (Requires Admin role)
- ✅ Okta authentication with OAuth 2.0 + PKCE
...
3. **Configure Okta environment variables**
   ```bash
...
3. **Edit `.env` with your actual Okta credentials**
